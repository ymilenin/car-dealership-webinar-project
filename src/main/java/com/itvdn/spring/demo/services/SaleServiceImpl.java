...
import com.itvdn.spring.demo.repositories.SaleRepository;
...
public class SaleServiceImpl implements SaleService {
    ...
    @Autowired
    public SaleServiceImpl(SaleRepository saleRepository, CarService carService, ManagerService managerService) {
